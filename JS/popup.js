...
// Hide all currently-visible non-popup dialogs
Popup.hideAll = function() {
	for (var i in Popup.objects) {
		var p = Popup.objects[i];
		if (!p.popup && p.autoHide) {
			p.hide();
		}
	}
};
...
Popup.show = function(divObject, referenceObject, position, options, popup) {
	var popup;
...
// A simple class method to show a popup popup
Popup.showpopup = function(divObject, referenceObject, position, options) {
...
// Show the popup
// --------------------------------------------------------------------
Popup.prototype.show = function(options, popup) {
	this.popup = this.popup || (typeof(popup)=="boolean" && popup);
	if (defined(options) && options!=null && typeof(options)=="object") {
		for (var i in options) {
			this[i] = options[i];
		}
	...
	if (this.popup && this.div.focus) {
		this.div.focus();
	}
};

// Show the popup but make it popup
// --------------------------------------------------------------------
...
// Show the popup but make it popup
// --------------------------------------------------------------------
Popup.prototype.showpopup = function(options) {
...
// Create a "screen" to make a popup popup
// --------------------------------------------------------------------
