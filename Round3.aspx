<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Round3.aspx.cs" Inherits="Team_Projects._Default" %>
...
<img alt="bander" src="Pictures/ttlbg-sitecopy.jpg" height="60px" 
        style="width: 100%" />
        <h3 class="ttlbg_heading">My Requests: Round 3</h3>
...
<asp:Content ID="Content" runat="server" ContentPlaceHolderID="Content"><br /><br /><br />
    ...
    <div class="my_request_left_panel">
        ...
        <div class="failed" style="border: 1px; background-color:#CCCCCC; Width: 700px; margin-left: 15px;">
        <br />
    ...
    <div class="pending" style="display:none; border: 1px; background-color:#CCCCCC; Width: 700px; margin-left: 15px;">
        <br />
        <a style="margin-left: 15px;">Results for this round will appear here.</a>
        <br />
        <br />
    ...
    <div class="allocated" style="display:none; border: 1px; background-color:#CCCCCC; Width: 700px; margin-left: 15px;">
        <br />
        <a style="margin-left: 15px;">Results for this round will appear here.</a>
        <br />
        <br />
