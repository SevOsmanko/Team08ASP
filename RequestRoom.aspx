...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">Request Room</asp:Content>
...
<table class="reqtable" style="width:100%;">
    <tr>
        ...
        <asp:SqlDataSource ID="mod_code_SqlDataSource" runat="server" 
                ...
                SelectCommand="SELECT moduleCode FROM dbo.Module WHERE departmentCode='CO' ORDER BY moduleCode"></asp:SqlDataSource>
            <div class="modulecode" for="moduleCode">Module<br />Code: *</div>
        </th>
        <td id="modcodelist">
            <asp:DropDownList ID="moduleCode" Enabled="true" runat="server" DataSourceID="mod_code_SqlDataSource" 
                DataTextField="mod_code" DataValueField="mod_code" AppendDataBoundItems="true" 
                AutoPostBack="True" onselectedindexchanged="moduleTitle_SelectedIndexChanged">
                 <asp:ListItem Text="-" Value="0" Selected="True"></asp:ListItem>
                </asp:DropDownList>

        <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
            ConnectionString="<%$ ConnectionStrings:team08ConnectionString %>" 
            SelectCommand="SELECT [moduleCode], [departmentCode], [moduleName] FROM [Module] WHERE ([departmentCode] = @departmentCode) ORDER BY [moduleName]">
            <SelectParameters>
                <asp:Parameter DefaultValue="CO" Name="departmentCode" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
        <th>
            <div class="module_title" for="moduleTitle">Module<br />Title: *</div>
        </th>
        <td id="modtitlelist">
            <asp:DropDownList ID="moduleTitle" runat="server" Enabled="true" DataSourceID="SqlDataSource2" 
        ...
        <td class="mod_pic">
            <label><strong>Add New Module?</strong></label>
            <asp:RadioButtonList ID="new_mod" runat="server" AutoPostBack="true" 
            RepeatDirection="Horizontal" 
                onselectedindexchanged="new_mod_SelectedIndexChanged">
        ...
        <tr class="mod_grid">
            <td >Enter New Module Code: </td>
            <td>
                <asp:TextBox ID="nmc" runat="server" Enabled="false"  
                    style="text-transform:uppercase; maxlength:'6';"  ontextchanged="nmc_TextChanged" ></asp:TextBox>
            </td>
            <td>Enter New Module Title: </td><td><asp:TextBox ID="nmt" runat="server" Enabled="false" maxlength="50"></asp:TextBox></td>
            <td>
                <asp:Button ID="addmodbtn" runat="server" Enabled="false" Text="Add Module" 
                    onclick="addmodbtn_Click"/>
            </td>          
        </tr>
    </tr>
    <tr>
        <th rowspan="2">
            <div class="day" for="day">Day: *</div>
        </th>
        <td rowspan="2"> 
        ...
        <th rowspan="2">
            <div class="period" for="period">Start time: *</div>
        </th>
        ...
        <div class="priority">Priority: 
            <asp:CheckBox ID="priority_checkbox" runat="server"/>
       </div>
        </td>
    </tr>
</table>
...
<br />
<div class='v'>
<fieldset class="roomreq" style="position:relative; float:left;">
...
<div class="reqtable" style="position:relative;">        
       ...
       <div class="rooms_bar">
        <div class="row">       
           ...
           <asp:RequiredFieldValidator ID="rfvstudents" runat="server" 
               ControlToValidate="noofStuds" style="margin-left:10px; color:Red;" ErrorMessage="Please enter number of students"></asp:RequiredFieldValidator>
      </div>
        <div class="rooms_bar">
        <div class="row">        
    ...
    <div class="rooms_bar">
        <div class="row">
	        <div class="left_cell" for="location_type">Select location by: </div>
            <div class="right_cell">
     ...
     <div class="rooms_bar">
		<div class="row">
            ...
            <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
                ConnectionString="<%$ ConnectionStrings:team08ConnectionString %>" 
                SelectCommand="SELECT [parkName], [parkCode] FROM [park] ORDER BY [parkName]">
            </asp:SqlDataSource>
            <asp:DropDownList id="parkDropDown" name="park" runat="server" 
             ...
             <div class="rooms_bar">
				<div class="row">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource4" runat="server" 
                        ConnectionString="<%$ ConnectionStrings:team08ConnectionString %>" 
                        SelectCommand="SELECT buildingName, buildingCode, parkCode FROM dbo.Building  ORDER BY buildingName" 
                        FilterExpression=" parkCode LIKE '{0}%'">
                        <FilterParameters>
             ...
             <div class="rooms_bar">
				<div class="row">
                <label class="left_cell">Room: </label>
                <div class="right_cell" >
                 <asp:SqlDataSource ID="SqlDataSource5" runat="server" 
                        ConnectionString="<%$ ConnectionStrings:team08ConnectionString %>" 
                        SelectCommand="SELECT dbo.Room.roomCode, dbo.Room.buildingCode, dbo.Building.buildingName FROM dbo.Room CROSS JOIN dbo.Building WHERE dbo.Building.buildingCode = dbo.Room.buildingCode ORDER BY dbo.Room.roomCode" 
                        FilterExpression="buildingName LIKE '{0}%'">
                        <FilterParameters>
...
<table class="reqtable" style="position:relative; float:left;">
    <tr>
        <th>
            <div class="weeks" for="wks">Weeks: *</div>
        </th>
...
<tr>
    ...
    <tr>          
        <th>
            <div class="special" for="specreq">Special Requirement:</div>
        </th> 
            <td>
